return {
    run = function(script, ...)
        ...
        if Settings.DoorInteractionType == "ProximityPrompt" then
            local AttachmentLeftPull = Instance.new("Attachment",
                                                    Door.Doors.DoorL.Pull)
            local AttachmentLeftPush = Instance.new("Attachment",
                                                    Door.Doors.DoorL.Push)

            InteractionLeftPull = Instance.new("ProximityPrompt",
                                               AttachmentLeftPull)
            InteractionLeftPush = Instance.new("ProximityPrompt",
                                               AttachmentLeftPush)
            ...
            local AttachmentRightPull = Instance.new("Attachment",
                                                     Door.Doors.DoorR.Pull)
            local AttachmentRightPush = Instance.new("Attachment",
                                                     Door.Doors.DoorR.Push)

            InteractionRightPull = Instance.new("ProximityPrompt",
                                                AttachmentRightPull)
            InteractionRightPush = Instance.new("ProximityPrompt",
                                                AttachmentRightPush)
        ...
        elseif Settings.DoorInteractionType == "ClickDetector" then
            InteractionRightPull = Instance.new("ClickDetector",
                                                Door.Doors.DoorL.Pull)
            InteractionRightPush = Instance.new("ClickDetector",
                                                Door.Doors.DoorL.Push)
        ...
        if Settings.DoorInteractionType == "ProximityPrompt" then
            InteractionLeftPull.Triggered:Connect(function(plr)
                DoorFunctions.Interaction(plr)
            end)
            InteractionLeftPush.Triggered:Connect(function(plr)
                DoorFunctions.Interaction(plr)
            end)
            InteractionRightPull.Triggered:Connect(function(plr)
                DoorFunctions.Interaction(plr)
            end)
            InteractionRightPush.Triggered:Connect(function(plr)
                DoorFunctions.Interaction(plr)
            end)
        elseif Settings.DoorInteractionType == "ClickDetector" then
            InteractionLeftPull.MouseClick:Connect(function(plr)
                DoorFunctions.Interaction(plr)
            end)
            InteractionLeftPush.MouseClick:Connect(function(plr)
                DoorFunctions.Interaction(plr)
            end)
            InteractionRightPull.MouseClick:Connect(function(plr)
                DoorFunctions.Interaction(plr)
            end)
            InteractionRightPush.MouseClick:Connect(function(plr)
                DoorFunctions.Interaction(plr)
            end)
        end

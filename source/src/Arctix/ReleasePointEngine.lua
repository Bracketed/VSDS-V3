return {
    run = function(script, ...)
        ...
        function Button.ToolReset(obj)
            ...
            if not Button.checkForWhitelist(
        ...
        elseif (settings.ButtonType == 'ClickDetector') then
            ButtonInteraction = Instance.new('ClickDetector',
                                             script.Parent.Parent.Parts.Element)
            ButtonInteraction.MaxActivationDistance = 10
        ...
        ResetInteraction = Instance.new('ClickDetector', script.Parent.Parent
                                            .Parts.CallpointBody.Body3)
        ResetInteraction.MaxActivationDistance = 0
        ...
        script.Parent.Parent.Parts.CallpointBody.Body3.Touched:Connect(function(
            obj) Button.ToolReset(obj) end)
    end
}

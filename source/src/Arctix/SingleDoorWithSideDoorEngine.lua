return {
	run = function(script, ...)
		...
		if Settings.DoorInteractionType == "ProximityPrompt" then
			local AttachmentPull = Instance.new("Attachment", Door.Doors.Door.Pull)
			local AttachmentPush = Instance.new("Attachment", Door.Doors.Door.Push)
			local AttachmentSideDoor = Instance.new("Attachment", Door.Doors.SideDoor.SideDoorSystem.Main)

			InteractionPull = Instance.new("ProximityPrompt", AttachmentPull)
			InteractionPush = Instance.new("ProximityPrompt", AttachmentPush)
			InteractionSideDoor = Instance.new("ProximityPrompt", AttachmentSideDoor)
		...
		elseif Settings.DoorInteractionType == "ClickDetector" then
			InteractionPull = Instance.new("ClickDetector", Door.Doors.Door.Pull)
			InteractionPush = Instance.new("ClickDetector", Door.Doors.Door.Push)
			InteractionSideDoor = Instance.new("ClickDetector", Door.Doors.SideDoor.SideDoorSystem.Main)
		...
		if Settings.DoorInteractionType == "ProximityPrompt" then
			InteractionPull.Triggered:Connect(function(plr) DoorFunctions.Interaction(plr) end)
			InteractionPush.Triggered:Connect(function(plr) DoorFunctions.Interaction(plr) end)
			InteractionSideDoor.Triggered:Connect(function(plr) DoorFunctions.SideDoorInteraction(plr) end)
		else
			InteractionPull.MouseClick:Connect(function(plr) DoorFunctions.Interaction(plr) end)
			InteractionPush.MouseClick:Connect(function(plr) DoorFunctions.Interaction(plr) end)
			InteractionSideDoor.MouseClick:Connect(function(plr) DoorFunctions.SideDoorInteraction(plr) end)
		end
